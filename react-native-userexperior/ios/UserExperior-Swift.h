...
// Generated by Apple Swift version 5.1 effective-4.2 (swiftlang-1100.0.266.1 clang-1100.0.32.1)
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="UserExperior",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
typedef SWIFT_ENUM(NSInteger, UECustomType, closed) {
  UECustomTypeTag = 0,
  UECustomTypeMsg = 1,
  UECustomTypeEvent = 2,
};
...
@interface UIApplication (SWIFT_EXTENSION(UserExperior))
...
+ (void)unmarkViewAsSensitive:(UIView * _Nonnull)view;
+ (void)consent;
+ (void)optIn;
+ (void)optOut;
...
SWIFT_CLASS("_TtC12UserExperior20UserExperiorInstance")
@interface UserExperiorInstance : NSObject
